...
const navItems = [
  ...
  { to: '/sales-forecast/upload', label: '銷售預估量表單上傳', permission: 'sales_forecast.upload' },
  ...
  { to: '/production-plan', label: '預估總表', permission: 'production_plan.view' },
  ...
  // ponytail: 暫時隱藏同步資料選單項目，路由與頁面仍保留
