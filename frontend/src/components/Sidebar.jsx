...
const navItems = [
  ...
  { to: '/sales-forecast/upload', label: '銷售預估量上傳-共同編輯界面', permission: 'sales_forecast.upload' },
  { to: '/gift-sales-forecast/upload', label: '禮品銷售預估量表單', permission: 'sales_forecast.upload' },
